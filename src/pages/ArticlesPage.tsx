...
import { articleFromApi, articleListApiPath, pageHref, parseBoundedPositiveInteger, parsePositiveInteger, safeLoadMessage, shouldShowEmptyState } from '../utils';

const articleListMaxLimit = 50;
...
export function ArticlesPage() {
  ...
  const limit = parseBoundedPositiveInteger(searchParams.get('limit'), 12, articleListMaxLimit);
  ...
  return (
    <PageShell title="资讯">
      ...
      <div className="page-list">
        ...
        {shouldShowEmptyState(apiState.isLoading, apiState.error, visibleItems.length) ? <div className="empty-state">没有匹配的文章线索，请调整筛选条件。</div> : null}
      </div>
